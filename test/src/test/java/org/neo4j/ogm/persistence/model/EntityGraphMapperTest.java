...
public class EntityGraphMapperTest extends MultiDriverTestClass {
    ...
    private MetaData mappingMetadata;
    ...
    public void setUpMapper() {
        ...
        session = new SessionFactory(baseConfiguration.build(), "org.neo4j.ogm.domain.policy",
                "org.neo4j.ogm.domain.election", "org.neo4j.ogm.domain.forum",
                "org.neo4j.ogm.domain.education").openSession();
