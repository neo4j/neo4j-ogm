...
public class GraphEntityMapper implements ResponseMapper<GraphModel> {
    ...
    private void setIdentity(Object instance, Long id) {
        ...
        FieldAccessor.write(classInfo.getField(fieldInfo), instance, id);
    }
    ...
    private void setProperties(Node nodeModel, Object instance) {
        ...
        if (compositeFields.size() > 0) {
            ...
            for (FieldInfo field : compositeFields) {
                ...
                FieldAccessor writer = EntityAccessManager.getPropertyWriter(classInfo, field.getName());
    ...
    private void writeProperty(ClassInfo classInfo, Object instance, Property<?, ?> property) {
        ...
        FieldAccessor writer = EntityAccessManager.getPropertyWriter(classInfo, property.getKey().toString());
        ...
        if (writer == null) {
            ...
            if (writer.type().isArray() || Iterable.class.isAssignableFrom(writer.type())) {
                FieldAccessor reader = EntityAccessManager.getPropertyReader(classInfo, property.getKey().toString());
                if (reader != null) {
    ...
    private boolean tryMappingAsSingleton(Object source, Object parameter, Edge edge, String relationshipDirection) {
        ...
        FieldAccessor writer = getRelationalWriter(sourceInfo, edgeLabel, relationshipDirection, parameter);
    ...
    private void mapRelationship(List<Edge> oneToMany, Edge edge, Object source, Object target) {
        ...
        if (!oneToOne) {
            ...
            FieldAccessor writer = getRelationalWriter(metadata.classInfo(source), edge.getType(), OUTGOING, target);
    ...
    private void mapRelationshipEntity(List<Edge> oneToMany, Edge edge, Object source, Object target, ClassInfo relationshipEntityClassInfo) {
        ...
        ClassInfo sourceInfo = metadata.classInfo(source);
        FieldAccessor writer = getRelationalWriter(sourceInfo, edge.getType(), OUTGOING, relationshipEntity);
        if (writer == null) {
    ...
    private Object createRelationshipEntity(Edge edge, Object startEntity, Object endEntity) {
        ...
        FieldAccessor startNodeWriter = EntityAccessManager.getStartOrEndNodeWriter(relEntityInfo, StartNode.class);
        ...
        FieldAccessor endNodeWriter = EntityAccessManager.getStartOrEndNodeWriter(relEntityInfo, EndNode.class);
    ...
    private void mapOneToMany(Collection<Edge> oneToManyRelationships) {
        ...
        for (Edge edge : oneToManyRelationships) {
            ...
            if (relationshipEntity != null) {
                ...
                FieldAccessor outgoingWriter = findIterableWriter(instance, relationshipEntity, edge.getType(), OUTGOING);
                ...
                FieldAccessor incomingWriter = findIterableWriter(parameter, relationshipEntity, edge.getType(), Relationship.INCOMING);
                ...
                FieldAccessor outgoingWriter = findIterableWriter(instance, parameter, edge.getType(), OUTGOING);
                if (outgoingWriter != null) {
                    entityCollector.recordTypeRelationship(edge.getStartNode(), parameter, edge.getType(), OUTGOING);
                    relationshipsToRegister.add(new MappedRelationship(edge.getStartNode(), edge.getType(), edge.getEndNode(), edge.getId(), instance.getClass(), ClassUtils.getType(outgoingWriter.typeParameterDescriptor())));
                }
                FieldAccessor incomingWriter = findIterableWriter(parameter, instance, edge.getType(), Relationship.INCOMING);
                if (incomingWriter != null) {
     ...
     */
    private FieldAccessor findIterableWriter(Object instance, Object parameter, String relationshipType, String relationshipDirection) {
        ClassInfo classInfo = metadata.classInfo(instance);
    ...
    private void mapOneToMany(Object instance, Class<?> valueType, Object values, String relationshipType, String relationshipDirection) {
        ...
        FieldAccessor writer = EntityAccessManager.getIterableWriter(classInfo, valueType, relationshipType, relationshipDirection);
        if (writer != null) {
            if (writer.type().isArray() || Iterable.class.isAssignableFrom(writer.type())) {
                FieldAccessor reader = EntityAccessManager.getIterableReader(classInfo, valueType, relationshipType, relationshipDirection);
