...
This part of the Spring Data Neo4j Guide book provides the reference documentation. It details many aspects of the
tutorial and also explains concepts that were only just mentioned there.

Its content covers information about the programming model, APIs, concepts, annotations and technical details of
Spring Data Neo4j.

Whenever you look for the means to employ the full power of the Spring Data Neo4j library, you should be able to find your answers in the reference section. If you don't, please inform us about missing or incorrect content so that we can fix that.
...
include::examples/samples.adoc[]
include::deployment/heroku.adoc[]
include::performance.adoc[]
include::neo4j/neo4j-server.adoc[]
:leveloffset: -1
