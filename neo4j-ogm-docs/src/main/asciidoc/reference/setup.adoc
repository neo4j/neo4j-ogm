...
// having created a new configuration object, we can either use it directly with the Components class...
Components.configure(configuration);

// or pass it as the first argument to a SessionFactory instance
