...
* Since Neo4j-OGM 3.2 all native temporal and spatial types are supported on Neo4j 3.4 and higher.
  You may want to disable all conversions to string or long based property types by xref:reference.adoc#reference:native-property-types:optin[opting in to the native type support].
