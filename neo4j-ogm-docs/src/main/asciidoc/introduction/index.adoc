...
If you are already familiar with Neo4j andNeo4j-OGM, feel free to jump directly
...
* The https://github.com/neo4j-examples/neo4j-ogm-university[sample project:Neo4j-OGM University]. This project is used in the <<tutorial:introduction,Tutorial>>.
...
* has an intuitive, rich graph-oriented model for data representation. Instead of tables, rows, and columns, you work with a graph consisting of http://neo4j.com/docs/developer-manual/current/introduction/#graphdb-neo4j[nodes, relationships, and properties].
