...
NOTE: The current Neo4j-OGM mainline is *3.2*. Please have a look at the current supported versions and which combinations we recommend: https://github.com/neo4j/neo4j-ogm/wiki/Versions#recommended-versions[Recommended versions]. 
We accept PRs to this branch, but no new features. 
For new features, base them on the current main branch. We can backport them together. 
If in doubt, please reach out by creating an issue.
...
Feel free to chat with us on the https://neo4j-users.slack.com[OGM Slack channel], and have a look to some examples like https://github.com/neo4j-examples/neo4j-ogm-university[Neo4j-OGM University].

You can also post questions on http://stackoverflow.com/questions/tagged/neo4j-ogm[StackOverflow].
