[[introduction]]
= Introduction
:description: This chapter is an introduction to graph databases, Neo4j, and the Neo4j object-graph mapping library (Neo4j-OGM).
...
to the xref:tutorial.adoc[tutorial] or xref:reference.adoc[reference] sections.

include::partial$/introduction/whats-new-ogm3.adoc[]
...
* The https://github.com/neo4j-examples/neo4j-ogm-university[sample project:Neo4j-OGM University].
  This project is used in the xref:tutorial.adoc#tutorial:introduction[Tutorial].
