...
If you plan on implementing `hashCode` and `equals` make sure *it does not* make sure of the Graph Id. See <<reference-graphid-annotation, Node Entities>> for more information.
[source, java]
----
