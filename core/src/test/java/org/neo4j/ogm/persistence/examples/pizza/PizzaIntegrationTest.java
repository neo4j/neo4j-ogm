...
public class PizzaIntegrationTest extends MultiDriverTestClass {
    ...
    public void init() throws IOException {
        sessionFactory = new SessionFactory(baseConfiguration, "org.neo4j.ogm.domain.pizza");
    ...
    public void shouldRaiseExceptionWhenAmbiguousClassLabelApplied() {
        ...
        Session session = new SessionFactory(baseConfiguration, "org.neo4j.ogm.domain.pizza", "org.neo4j.ogm.domain.music").openSession();
