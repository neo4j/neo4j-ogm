...
xref:reference.adoc#reference:indexing[Indexing] has everything you will want to know when it comes to getting that working.
...
The chapter on xref:reference.adoc#reference:ha[High Availability] goes into all the options Neo4j-OGM provides to support this.
