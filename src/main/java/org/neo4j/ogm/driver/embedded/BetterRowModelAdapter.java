 ...
 * @author vince
 */
public class BetterRowModelAdapter extends ModelAdapter implements ResponseAdapter<Result, RowModel> {
     ...
     * @return
     */
    public RowModel adapt(Result result) {
        ...
        try {
            return mapper.readValue(sb.toString().getBytes(), RowModel.class);
        } catch (Exception e) {
