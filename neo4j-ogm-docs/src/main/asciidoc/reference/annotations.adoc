[[reference-programming-model-annotations]]
= Annotating Entities


[[reference-node-entity-annotation]]
...
[[reference-relationship-annotation]]
...
[[reference-programming-model-relationships-relationshiptypediscrimination]]
...
* The @Relationship annotations are explicit.
  This means if the entity has setter methods, they must be annotated
...
[[reference-relationship-entity-annotation]]
...
Custom converters are also specified by using `@Convert` - this is discussed in detail <<reference-programming-model-conversion, later on>>.
...
//
//[[reference-programming-model-typerepresentationstrategy]]
...
//Node entities are declared using the `@NodeEntity` annotation.
//Relationship entities use the `@RelationshipEntity` annotation.

//
//[[reference-programming-model-relationships]]
