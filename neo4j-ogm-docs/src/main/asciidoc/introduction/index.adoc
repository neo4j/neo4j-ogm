...
If you are already familiar with Neo4j and OGM, feel free to jump directly
...
* The https://github.com/neo4j-examples/neo4j-ogm-university[sample project: OGM University]. This project is used in the <<tutorial:introduction,Tutorial>>.
...
* can be deployed as an embedded (in-process) database, giving developers access to its core Java https://neo4j.com/docs/#api[API].
