...
/**
 * Specification for an object-graph mapper, which can map {@link org.neo4j.ogm.model.Graph}s onto arbitrary Java objects.
 *
...
public interface GraphToEntityMapper<G extends Graph> {
    ...
    /**
     * Maps the data representation in the given {@link org.neo4j.ogm.model.Graph} onto an instance of <code>T</code>.
     *
     * @param type The {@link Class} defining the type to which each entity in the graph should be mapped
     * @param graph The {@link org.neo4j.ogm.model.Graph} model containing the data to map onto the object
