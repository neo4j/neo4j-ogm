...
* [dependencies] Bump org.apache.maven.plugins:maven-surefire-plugin (#1483)
* [dependencies] Bump js-yaml, @antora/cli and @antora/site-generator-default (#1489)
* [dependencies] Bump org.apache.maven.plugins:maven-compiler-plugin (#1484)
* [dependencies] Bump org.apache.maven.plugins:maven-failsafe-plugin (#1485)
* [dependencies] Bump org.jreleaser:jreleaser-maven-plugin (#1486)
* [dependencies] Bump com.puppycrawl.tools:checkstyle from 14.0.0 to 14.1.0 (#1487)
* [dependencies] Bump net.bytebuddy:byte-buddy from 1.18.12 to 1.18.13 (#1488)


=== 5.0.9

The build has been moved to JDK 26, while being still compiled for JDK 17. Only dependency updates, no other changes.

* [dependencies] Bump com.fasterxml.jackson:jackson-bom (#1477)
* [dependencies] Bump net.bytebuddy:byte-buddy from 1.18.11 to 1.18.12 (#1474)
* [dependencies] Bump com.github.spotbugs:spotbugs-maven-plugin (#1475)
* [dependencies] Bump ch.qos.logback:logback-classic from 1.6.2 to 1.6.3 (#1476)
* [dependencies] Bump com.puppycrawl.tools:checkstyle from 12.3.1 to 14.0.0 (#1479)
* [dependencies] Bump io.github.classgraph:classgraph (#1480)
* [dependencies] Bump org.neo4j:neo4j-cypher-dsl-bom (#1481)
* [dependencies] Bump com.mycila:license-maven-plugin from 5.1.1 to 5.1.2 (#1482)


=== 5.0.8

This is a recommended update for all users. It includes several important security fixes and has no breaking changes or other side effects.

* [fix] Group entities also by removed / updated properties before multi-statement updates. (#1473)
* [refactor] Replace variable placeholder `$` in favor of passing the variable down the call stack. (#1472)
* [fix] Use the full classname to lookup class info during query execution and deletion. (#1471)
* [refactor] Use Cypher-DSL Schema Names support to uniformly escape names. (#1470)
* [dependencies] Bump org.junit:junit-bom from 6.1.2 to 6.1.3 (#1465)
* [dependencies] Bump org.neo4j.driver:neo4j-java-driver from 6.2.0 to 6.2.1 (#1466)
* [dependencies] Bump io.github.classgraph:classgraph (#1467)
* [dependencies] Bump ch.qos.logback:logback-classic from 1.6.1 to 1.6.2 (#1468)
* [dependencies] Bump org.apache.maven:apache-maven from 3.9.11 to 3.9.16 (#1469)
* [chore] Minor remaining polishing of the `Configuration` class.
* [dependencies] Bump org.jreleaser:jreleaser-maven-plugin (#1448)
* [dependencies] Bump com.fasterxml.jackson:jackson-bom (#1452)
* [dependencies] Bump kotlin.version from 2.4.0 to 2.4.10 (#1453)
* [dependencies] Bump com.mycila:license-maven-plugin from 5.0.0 to 5.1.1 (#1454)
* [dependencies] Bump net.bytebuddy:byte-buddy from 1.18.10 to 1.18.11 (#1447)
* [dependencies] Bump com.github.spotbugs:spotbugs-maven-plugin (#1449)
* [dependencies] Bump org.junit:junit-bom from 6.1.1 to 6.1.2 (#1450)
* [dependencies] Bump org.apache.maven.plugins:maven-jar-plugin (#1455)
* [dependencies] Bump brace-expansion, @antora/cli, @antora/site-generator-default and nodemon (#1458)
* [dependencies] Bump ch.qos.logback:logback-classic from 1.5.37 to 1.6.1 (#1459)
* [dependencies] Bump io.github.classgraph:classgraph (#1460)
* [refactor] Fully rebuild the URL without the `userInfo` part instead of search and replace. (#1464)
* [refactor] Throw `IllegalArgumentException` when a non-supported `encryptionLevel` is used. (#1463)
* [fix] Handle colons in passwords proper. (#1462)
* [docs] Add page-tabs attributes (#1461)
* [dependencies] Bump org.junit:junit-bom from 6.1.0 to 6.1.1 (#1441)
* [dependencies] Bump com.github.spotbugs:spotbugs-maven-plugin (#1442)
* [dependencies] Bump commons-logging:commons-logging from 1.3.6 to 1.4.0 (#1443)
* [dependencies] Bump net.bytebuddy:byte-buddy from 1.18.8 to 1.18.10 (#1444)
* [dependencies] Bump ch.qos.logback:logback-classic from 1.5.34 to 1.5.37 (#1445)
* [build] Pin all actions (including officials) to their current sha. (#1446)
* [docs] Remove broken Stackoverflow badge.


=== 5.0.7

* [dependencies] Bump org.neo4j.driver:neo4j-java-driver from 6.1.0 to 6.2.0
* [dependencies] Bump kotlin.version from 2.3.21 to 2.4.0 (#1438)
* [dependencies] Bump com.fasterxml.jackson:jackson-bom (#1434)
* [dependencies] Bump org.apache.maven.plugins:maven-surefire-plugin (#1435)
* [dependencies] Bump qs and express in /neo4j-ogm-docs (#1429)
* [dependencies] Bump org.apache.maven.plugins:maven-site-plugin (#1430)
* [dependencies] Bump org.apache.maven.plugins:maven-enforcer-plugin (#1431)
* [dependencies] Bump org.junit:junit-bom from 6.0.3 to 6.1.0 (#1432)
* [dependencies] Bump io.mockk:mockk-jvm from 1.14.9 to 1.14.11 (#1433)
* [dependencies] Bump org.apache.maven.plugins:maven-failsafe-plugin (#1437)
* [dependencies] Bump org.jacoco:jacoco-maven-plugin from 0.8.14 to 0.8.15 (#1439)
* [dependencies] Bump ch.qos.logback:logback-classic from 1.5.32 to 1.5.34 (#1440)
...
The 5.0.x series of Neo4j-OGM uses the 6 series of the Neo4j Java driver underneath. It is not compatible with the previous major version 5 of the driver.
We took the opportunity to finally remove all remains of the `AutoIndexManager` in Neo4j-OGM and would like to point out to https://github.com/michael-simons/neo4j-migrations[Neo4j-Migrations] for all things schema and index management.
There are no further changes in the fundamental Object-mapping framework, any upgrade should be a drop-and-replace update.
