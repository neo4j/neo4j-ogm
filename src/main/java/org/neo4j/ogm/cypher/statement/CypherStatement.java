 ...
 */
public class CypherStatement implements Statement {
    ...
    /**
     * Constructs a new {@link CypherStatement} based on the given Cypher query string and query parameters.
     *
     ...
     */
    public CypherStatement(String cypher, Map<String, ?> parameters) {
